import { ArrowLeft, Clock, BarChart3, ListChecks, Zap, Download, FileText } from 'lucide-react';
            ...
            <div className="report-card">
                ...
                <div className="report-meta">
                    ...
                    <div className="meta-item">
                        ...
                        <span>{isParadoxMode ? 'Paradox Mode' : 'Standard Session'}</span>
                    </div>
                </div>
                ...
                {isParadoxMode && (
                    <div className="report-section paradox-summary-section">
                        <h3><Zap size={18} className="active-icon" /> Paradox Interference Summary</h3>
                        <div className="paradox-insight-card">
                            ...
                            <div className="interference-stats">
                                <span>Anomaly Intensity: High</span>
                                <span>Singularity Stability: 12%</span>
                            </div>
                        </div>
                    </div>
                )}
