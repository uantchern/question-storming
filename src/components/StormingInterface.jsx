...
function StormingInterface({ scenario, isParadoxMode, onTimeUp, initialQuestions, onUpdateQuestions }) {
    ...
    const handleNo = () => {
        ...
        text += `\n*Questions Generated:*\n`;
        initialQuestions.forEach((q, i) => text += `${i + 1}. ${q.text}\n`);
    ...
    return (
        <div className={`storming-container fade-in ${isParadoxMode ? 'paradox-active' : ''}`}>
            ...
            {!showInput ? (
                <div className="storm-again-prompt" style={{ textAlign: 'center', marginTop: '2rem', marginBottom: '2rem' }}>
                    <h3 style={{ marginBottom: '1.5rem', color: 'white', fontSize: '1.5rem' }}>Storm again?</h3>
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                        <button className="primary-btn" style={{ minWidth: '120px' }} onClick={() => setShowInput(true)}>Yes</button>
